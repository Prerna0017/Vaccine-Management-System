...
public class BarChart extends JFrame {
    ...
    public BarChart(int[] indices, int[] values, int minIndex, int maxIndex, int minValue, int maxValue, int x_labels_gap, int y_labels_gap) {
        super();
    ...
    public static void main(String[] args) {
        ...
        int[] indices = {1,2,3,4};
        int[] values = {10,20,15,30};
        BarChart chart = new BarChart(indices, values, 0, indices[indices.length - 1] + 2, 0, 40, 1, 5);
